...
class BookSearchResult(BaseModel):
    """A single book result from Google Books search."""
...
class UserSearchResult(BaseModel):
    """A single user result from search."""
...
class ListSearchResult(BaseModel):
    """A single book list result from search."""
...
class UnifiedSearchResponse(BaseModel):
    """Unified search response combining books, users, and lists."""
...
class SearchHistoryResponse(BaseModel):
    """Response containing search history items."""
...
class TrendingSearch(BaseModel):
    """A single trending search term with count."""
...
class TrendingSearchesResponse(BaseModel):
    """Response containing trending searches."""
